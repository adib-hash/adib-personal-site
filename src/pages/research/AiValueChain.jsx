    ...
    <div className="research-root-ai" style={{background:"#F9F8F5",minHeight:"100vh",fontFamily:"'DM Sans',system-ui,-apple-system,sans-serif"}}>
      ...
      <header style={{background:"linear-gradient(175deg,#080B14 0%,#0F1628 50%,#141A30 100%)",padding:"min(10vw,72px) 20px min(8vw,56px)",position:"relative",overflow:"hidden"}}>
        ...
        <div style={{maxWidth:600,margin:"0 auto",position:"relative"}}>
          <div style={{opacity:heroVis?1:0,transform:heroVis?"none":"translateY(18px)",transition:"all 0.8s ease 0.1s",textAlign:"center"}}>
            ...
            <p style={{fontSize:"clamp(14px,3.5vw,16px)",color:"#94A3B8",lineHeight:1.65,marginTop:18,maxWidth:480,marginLeft:"auto",marginRight:"auto",fontWeight:300}}>
