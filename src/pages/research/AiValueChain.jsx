...
export default function App(){
  ...
  return(
    <div className="research-root-ai" style={{background:"#F9F8F5",minHeight:"100vh",fontFamily:"'DM Sans',system-ui,-apple-system,sans-serif"}}>
      ...
      <style>{`*{box-sizing:border-box;margin:0}::selection{background:#D9770640}html{-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;scroll-behavior:smooth}@media(max-width:480px){.stat-grid{grid-template-columns:repeat(2,1fr)!important}.ro-grid{grid-template-columns:1fr!important}}@media(min-width:1024px){.research-root-ai main{max-width:820px!important;padding:0 48px 160px!important}.research-root-ai a[aria-label="Back to research"]{top:24px!important;left:24px!important;padding:12px 18px!important;font-size:13px!important;gap:8px!important}.research-root-ai a[aria-label="Back to research"] span:first-child{font-size:16px!important}.research-root-ai .back-btn-label::after{content:" to research"}.research-root-ai header{padding:96px 48px 80px!important}.research-root-ai header>div:last-child{max-width:820px!important}.research-root-ai header h1{font-size:clamp(48px,4.8vw,76px)!important;max-width:820px!important}.research-root-ai header p{max-width:620px!important;font-size:18px!important}}@media(min-width:1280px){.research-root-ai main{max-width:920px!important}.research-root-ai header>div:last-child{max-width:920px!important}}`}</style>
      ...
      {/* BODY */}
      <main style={{maxWidth:700,margin:"0 auto",padding:"0 clamp(16px,4vw,24px) 120px"}}>
      ...
      <ResearchFooter currentSlug="ai-value-chain" />
    </div>
  );
}
