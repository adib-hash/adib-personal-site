...
import audioManifest from "../../../data/audio/gta.json";
...
export default function GtaSaga() {
  ...
  return <div className="gta-root" style={{ background: C.bg, color: C.text, minHeight: "100vh", overflowX: "hidden", fontFamily: "var(--gta-serif)" }}>
    ...
    <header style={{ position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ maxWidth: W, margin: "0 auto", padding: "clamp(88px, 14vh, 150px) 24px 64px", position: "relative" }}>
        ...
        <p style={{
          ...
          How a bug in a Scottish racing game became the most profitable entertainment product ever made, why its maker spent thirteen years <em>not</em> building a sequel, and why the rest of the industry is clearing the road for November 19.
        </p>
    ...
    <section style={{ ...SEC, paddingTop: 24 }}>
      <P>A video game released in September 2013, for consoles now two generations obsolete, has sold more than 230 million copies and grossed more money than any film, album or book in history, according to the analysts who track it.<R n={44} /><R n={41} /> Its publisher's revenue has risen more than fivefold since.<R n={56} /> The sequel arrives on <Strong>November 19</Strong> at $79.99, with no disc in the box and no multiplayer at launch, and it is already the strongest pre-order campaign anyone has measured.<R n={85} /><R n={89} /></P>
      <P>Rockstar Games employs a few thousand people and works out of offices above a Manhattan street. Last autumn it fired staff who were organising a union, and the tribunal runs right up to launch. It spent this summer filing takedown notices against leaked footage of its own product.<R n={83} /><R n={84} /><R n={97} /> By any commercial measure it is also the most successful studio in the medium, and it has shipped two new games in eight years.</P>
      <Ed>Rockstar decided early that it would rather be a record label than a software firm. It treated controversy as a distribution channel until the day a US Senator got involved, and it stumbled into a business model that turned a one-time purchase into a thirteen-year annuity. The story starts in a factory town on the east coast of Scotland.</Ed>
    </section>
    ...
    {/* ---------------- CH 00 ---------------- */}
    <Section id="ch0">
      <H2 num="00" label="Chapter 00 · Before Rockstar">A redundancy cheque in Dundee</H2>
      ...
      <P><em>Lemmings</em> gave a studio in a city with no games industry both the money and the standing to attempt something ambitious. It was also, at heart, a game about watching a crowd of small, stupid, autonomous creatures walk into danger and finding that delightful.</P>
      <Ed>Emergent behaviour, meaning systems that produce stories nobody scripted, runs through Rockstar's entire history. It is in <em>Lemmings</em>, in the bug that made <em>Grand Theft Auto</em> work, and eventually in the whole business model of GTA Online. DMA got it right the first time, then spent a decade learning how to sell it.</Ed>
    </Section>
    ...
    <Section id="ch1">
      ...
      <Quote author="Gary Penn, DMA Design, on the pitch for the game">The game as it stands now is basically Elite in a city.</Quote>
    ...
    <Section id="ch2">
      ...
      <P>Fourteen million dollars bought the entire franchise.</P>
      ...
      <Ed>By the end of 1999 Take-Two had assembled the whole thing for less than $30 million: the intellectual property, the team that made it, and two brothers who understood they were selling a brand rather than a program. Almost every dollar the company has earned since traces back to those two transactions.</Ed>
      ...
      <TitleChart />
      <Quote author="Sam Houser, 2002">The problem with other games is that when you hit a point that's frustrating, you can't get past it. In Grand Theft Auto, when you hit a point that's tough, just go do something else.</Quote>
      <P>Three games in three years, each bigger than the last, each made for a fraction of what a Hollywood film cost, each with a licensed radio soundtrack and a celebrity cast (Ray Liotta as Tommy Vercetti, Samuel L. Jackson as a crooked cop) that made it feel like a record label had wandered into software.<R n={20} /><R n={21} /> For a moment, Rockstar was the coolest company in entertainment.</P>
    </Section>
    ...
    <Section id="ch3">
      ...
      <Quote author="Sam Houser, Develop magazine, August 2008">Most of the people who hate us are people it is truly an honor to be hated by: reactionary creeps with strange agendas, and the Daily Mail.</Quote>
      <Ed>Rockstar did not respond by toning anything down; <em>GTA IV</em> and <em>V</em> are, if anything, more pointed. The response was operational. The company became obsessive about controlling its own content, its own leaks and its own message. Every decision that baffles people about Rockstar today, from the near-total press silence to the code-in-a-box physical edition of GTA VI, traces back to the summer a hidden minigame cost it $24.5 million and a Senate hearing.</Ed>
    </Section>
    ...
    <Section id="ch4">
      ...
      <Ed>Owning the engine is the decision that compounded. Every Rockstar game since, including GTA VI, runs on RAGE. The company controls its rendering, its physics, its streaming of enormous open worlds and, most consequentially, its own release schedule. A competitor had bought the tool its business ran on, and Rockstar's answer was to become a technology company. Most studios would have licensed Unreal.</Ed>
    </Section>
    ...
    <Section id="ch5">
      ...
      <GtaVChart />
      <P>Games have tails, and blockbusters usually sell most of what they will ever sell in the first year. <em>GTA V</em> did not stop. It was re-released on the PlayStation 4 and Xbox One in November 2014 and sold another twelve million copies in the following twelve months. The PC version came in April 2015.<R n={107} /><R n={43} /> When Epic gave it away free for a week in May 2020, demand took the Epic Games Store offline for eight hours.<R n={45} /> In March 2022 it launched on a third generation of consoles.<R n={107} /> As of August 2026, Take-Two reports 230 million copies sold and calls it the best-selling title of the past decade by units and dollars.<R n={44} /></P>
      <Quote author="Doug Creutz, Cowen, April 2018">Another GTA V isn't likely. Michael Jackson had a lot of hit albums but he only had one Thriller.</Quote>
    ...
    <Section id="ch6">
      ...
      <Ed>GTA Online was both the best and the worst thing that happened to the medium in the 2010s. It proved that a story-driven blockbuster and a live economy could coexist. It also convinced a generation of executives that the economy was the point, and most of them did not have a Los Santos to put it in.</Ed>
    ...
    <Section id="ch7">
      ...
      <P>Every analyst covering Take-Two asked the same question for a decade. If <em>GTA V</em> made that much money, why did the sequel take thirteen years?</P>
      <P>Part of the answer is that the money itself was the obstacle. As long as Online kept growing, a sequel threatened the annuity as much as it promised to extend it. Part is that Zelnick meant what he said about pacing. "We're not a cadence-driven company," he told a TD Cowen conference this May. Annualising, he said, would "burn off our intellectual property, because you're in market too often and you can't possibly deliver the quality you need to deliver."<R n={73} /></P>
      <P>The rest of the answer is that the intervening years were harder inside Rockstar than the revenue suggests.</P>
    ...
    <Section id="ch8">
      ...
      <P>The next evening, the company put a 26-minute gameplay presentation, "An Extended Look," on Netflix, exclusively, at 3 PM Eastern. Netflix briefly fell over. The special topped the service's US film chart and, by Sensor Tower's count, lifted Netflix's web traffic 125% in a day.<R n={95} /><R n={96} /> Zelnick's explanation for the venue: the goal is "to be on every social media channel on earth."<R n={91} /> Alongside it came the first developer interviews in years: NPCs who notice and comment on how you behave; characters whose bodies change with diet, exercise and sleep; character switching between Jason and Lucia mid-mission; a "Bonnie and Clyde" story at the centre.<R n={98} /></P>
      <Ed>The last three years have run in this order: a hack, a leak, a trailer released early because of a leak, two delays, a labour dispute, another leak, an apology, and a Netflix premiere. Rockstar's control of its own message, the discipline it built after Hot Coffee, has been tested harder in this cycle than at any point in its history, and the pre-order data suggests none of it mattered. Either the brand is the strongest in entertainment or the audience is the most patient. Probably both.</Ed>
    </Section>
    ...
    <Section id="ch9">
      ...
      <Lesson n="01"><b>Keep the bug.</b> The most valuable feature in a $475-million-unit franchise was a pathfinding error that testers refused to let anyone fix. The discipline it requires is an eye for the moment a system starts producing more fun than the design intended, and the willingness to rebuild the design around what the system found. Rockstar has done this at every scale since, up to and including buying the modders who built roleplay servers on top of its game.</Lesson>
      <Lesson n="02"><b>Outrage is a channel, until it is a subpoena.</b> Max Clifford's campaign in 1997 was free marketing. Hot Coffee in 2005 cost $24.5 million and a Senate hearing. What separated them was disclosure: Hot Coffee handed critics something the company had concealed. Provocation works for as long as you control the facts.</Lesson>
      <Lesson n="03"><b>Own the thing your business runs on.</b> When EA bought Criterion and took RenderWare off the market, Rockstar built RAGE instead of licensing a replacement. Twenty years later it still owns its engine, its physics, its tools and its schedule. The short-term cost was a six-month delay on GTA IV. The long-term return is every game since.</Lesson>
      <Lesson n="04"><b>Scarcity is a strategy.</b> Two new games in eight years reflects a deliberate release policy rather than a throughput problem. "We're not a cadence-driven company," Zelnick says, and the pre-order data proves the market believes him. The pattern is closer to Pixar than to Ubisoft: few releases, each treated as an event, each expected to sell for a decade.</Lesson>
      <Lesson n="05"><b>The tail is the business.</b> Take-Two earned 84% of its bookings last quarter from spending inside games people already owned. The launch is the customer-acquisition cost; the annuity is the product. Any business with a one-time purchase and a reason for the customer to come back has the same option, and most never take it.</Lesson>
      <Lesson n="06"><b>Say less.</b> Rockstar has not run a conventional press cycle in fifteen years. It communicates through trailers, terse Newswire posts and, this month, a Netflix special. Every word it publishes is scarce, so every word is news. Silence, at sufficient scale, is a media strategy.</Lesson>
      <Lesson n="07"><b>Hype has a bill, and it comes due inside the company.</b> Crunch letters in 2010 and 2018, a $150 million royalty suit, four of five founders gone, and a union tribunal that runs to mid-October. The external story is a triumph. The internal one is the cost of building the largest entertainment product in history with people, and it is not finished being paid.</Lesson>
      <P>In 1998 Take-Two paid about $14 million for the rights to <em>Grand Theft Auto</em>. This November, its sixth numbered sequel will go on sale at $80, to a public that has already, by the most conservative external estimate, committed hundreds of millions of dollars to it sight unseen. Somewhere in Edinburgh, a team that has doubled in size since 2018 is finishing a city.<R n={98} /></P>
      <P>Whether it was worth the wait gets settled on November 19.</P>
    </Section>
    ...
    <Section id="sources">
      <FadeIn>
        <div style={{ margin: "0 0 32px" }}>
          ...
          <h2 style={{ fontFamily: "var(--gta-display)", fontSize: "clamp(32px, 5vw, 44px)", lineHeight: 1.08, color: C.text, margin: 0, fontWeight: 700, letterSpacing: "-0.015em" }}>Sources</h2>
        </div>
      </FadeIn>
      <SP>Every figure in this narrative carries a bracketed reference. Hover a marker to see the source; click it to jump here. Fiscal years are Take-Two's, ending March 31. Sales figures are company-reported units at the last disclosed date unless labelled as estimates.</SP>
      <FadeIn>
