  ...
  return (
    <div className="lh-root" style={{ background: C.bg, minHeight: "100vh", color: C.text, fontFamily: "var(--lh-serif)" }}>
      ...
      <section id="ch0" style={{ maxWidth: 920, margin: "0 auto", padding: "0 24px 64px" }}>
        ...
        <P>And Paramount Global, which owned CBS, MTV, Nickelodeon, BET, Pluto TV, and the Paramount lot, was adrift. Shari Redstone had been shopping her family stake for two years. Everyone knew it. The question wasn't whether Paramount would sell. It was to whom, for how much, and on what terms.</P>
      ...
      <section id="ch5" style={{ maxWidth: 920, margin: "0 auto", padding: "0 24px 64px" }}>
        ...
        <P>On January 13, Netflix converted its offer to all-cash at the same $27.75 a share. Nine days later, the Department of Justice issued a Second Request, freezing the clock.<Rf n={1}/> That was the moment the Netflix deal died, and not because the DOJ formally objected. It died because every WBD shareholder watching the calendar understood Netflix was at least another year from closing. Cash now from Paramount, or paper-maybe later from Netflix.</P>
      ...
      <section id="ch9" style={{ maxWidth: 920, margin: "0 auto", padding: "0 24px 64px" }}>
        ...
        <P>Whatever you think of the Ellisons, David&rsquo;s path from a Skydance producer credit to a $111B acquisition in twenty months is a master class in offensive M&amp;A. Here are the transferable lessons. Not because you&rsquo;ll ever buy a studio, but because the playbook generalizes to any contested auction.</P>
