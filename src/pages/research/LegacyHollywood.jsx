...
const timelineEvents = [
  { date: "Jan 2024", phase: "setup", title: "Skydance eyes Paramount", body: "David Ellison floats a $2.5B all-cash bid. Paramount is drifting, and Shari Redstone has been quietly shopping her family's NAI stake for two years." },
  { date: "Apr 2, 2024", phase: "setup", title: "Exclusive window opens", body: "Paramount's special committee grants Skydance an exclusive negotiating window. Sony and Apollo are circling from the outside." },
  { date: "May 2024", phase: "setup", title: "Apollo and Sony counter", body: "A $26B non-binding proposal from Apollo Global and Sony lands on Redstone's desk. Skydance's exclusive window lapses a few days later." },
  { date: "Jul 2, 2024", phase: "setup", title: "Skydance wins Paramount", body: "Three pieces: $2.4B for NAI, $4.5B for shareholders, $1.5B primary. Combined value about $28B." },
  { date: "Jul 2, 2025", phase: "pivot", title: "CBS pays Trump $16M", body: "Paramount settles the 60 Minutes suit a week before the FCC greenlight. Colbert gets cancelled 16 days later." },
  { date: "Aug 7, 2025", phase: "pivot", title: "Day One of a new Paramount", body: "Deal closes. Ellison takes Chairman and CEO. Shell becomes President. Redstone exits the board. Oracle wires the streaming backend." },
  { date: "Sep 10, 2025", phase: "pivot", title: "The undisturbed price", body: "WBD closes at $12.54. Days later Ellison proposes $19 a share. Rejected." },
  { date: "Dec 4, 2025", phase: "war", title: "Netflix wins the auction", body: "WBD signs an $82.7B deal with Netflix. Studios and HBO Max go to Los Gatos. Cable networks get spun off into a separate company." },
  { date: "Dec 8, 2025", phase: "war", title: "Hostile tender launched", body: "Paramount drops a $30 all-cash offer for the entire company. Implied value about $108B. Larry Ellison is the backstop." },
  { date: "Feb 26, 2026", phase: "win", title: "Superior proposal", body: "WBD's board declares Paramount's $31 offer superior to the Netflix agreement. A 147% premium to the undisturbed price." },
  { date: "Feb 27, 2026", phase: "win", title: "Netflix walks away", body: "Sarandos and Peters decline to match: 'The deal is no longer financially attractive.' Paramount signs a $110.9B agreement." }
];
...
const financingData = [
  { source: "Bank debt (18-bank syndicate)", value: 49, color: "#b83030", note: "BofA, Citi, Apollo, plus 15 others. Restructured down from a $54B bridge." },
  { source: "Ellison family + RedBird", value: 22, color: "#c8934c", note: "100% of the voting shares. The backstop that beat Netflix." },
  { source: "Assumed WBD net debt", value: 15, color: "#9b7fc4", note: "Existing WBD leverage that comes along at close." },
...
const playbookLessons = [
  { n: "01", title: "Patient capital beats smart capital", body: "The Ellisons outlasted every financial bidder, every board, every news cycle. When your horizon is twenty years and your backer is the third-richest man alive, you mostly just need to outlast anyone who isn't." },
  { n: "02", title: "Political access is strategic infrastructure", body: "Before launching the Warner bid, Paramount had already settled a presidential lawsuit, cancelled a late-night host, installed a Trump-friendly CBS News editor, and scrapped DEI. That isn't PR. It's a regulatory moat." },
  { n: "03", title: "Sovereign wealth is the new LBO fund", body: "Saudi, UAE, and Qatar put up $24B and took zero board seats to dodge CFIUS. The Gulf is no longer a limited partner in American media. It's a senior underwriter." },
  { n: "04", title: "Scale is not a moat; the lack of scale is a death sentence", body: "Paramount-Warner controls about 27% of US box office, around 200M streaming subs, and the biggest cable portfolio still standing. That doesn't buy them victory against Netflix. It buys them the right to keep playing." },
  { n: "05", title: "In hostile auctions, the highest bidder is the most committed bidder", body: "Netflix had the larger cap, the better balance sheet, the ratings advantage. Paramount had something more expensive than money: a buyer who didn't care about near-term EPS. When the numbers got uncomfortable, Netflix walked. That was the whole point of the pressure." },
  { n: "06", title: "The acquirer's balance sheet is the real constraint", body: "Paramount closes with about $79B of net debt, roughly five turns of EBITDA on day one. Every dollar of synergy and every job cut for five years is pre-committed to lenders. The Ellisons didn't exactly buy freedom. They bought obligation, with a lot of upside attached." }
];
  ...
  return (
    <div className="lh-root" style={{ background: C.bg, minHeight: "100vh", color: C.text, fontFamily: "var(--lh-serif)" }}>
          ...
          <HeroReveal delay={720}>
            <div style={{
              ...
              <p style={{ fontFamily: "var(--lh-display)", fontSize: 22, lineHeight: 1.38, color: C.text, margin: "0 0 24px", fontWeight: 400 }}>
                On September 10, 2025, Warner Bros. Discovery closed at{" "}
                <strong style={{ color: C.red, fontWeight: 700 }}>$12.54</strong>. Twenty weeks later it sold for{" "}
                <strong style={{ color: C.accent, fontWeight: 700 }}>$31</strong> a share in cash. The loser walked because the number got too high.<Rf n={1}/>
              </p>
      ...
      <section id="ch0" style={{ maxWidth: 920, margin: "0 auto", padding: "0 24px 64px" }}>
        ...
        <P>To understand why Ellison spent 2025 chasing Warner Bros., you have to look at the hole legacy media had dug for itself. In early 2024, Netflix was the only pure streamer that had ever turned a sustained profit on content it did not own. Disney had spent half a decade digesting its $71B Fox acquisition. Comcast was spinning its cable networks into a sidecar called Versant. Warner Bros. Discovery, the rubble of a 2022 merger, was trading at a fraction of book value with $37B of debt on its back.<Rf n={13}/></P>
        <P>And Paramount Global, which owned CBS, MTV, Nickelodeon, BET, Pluto TV, and the Paramount lot, was adrift. Shari Redstone had been shopping her family stake for two years. Everyone knew it. The only open questions were to whom Paramount would sell, for how much, and on what terms.</P>
        <Ed>The streaming wars had a quiet second act. Phase one was "spend everything to matter." Phase two was "find a partner before your linear business implodes." By 2024, every legacy studio needed a dance partner. A few of them had no one to dance with.</Ed>
        <P>Into that vacuum walked David Ellison, a 39-year-old producer who started Skydance in 2010 on a $350M loan from his father, backed Tom Cruise's biggest films, and now wanted the whole studio for himself.<Rf n={2}/> The son had the ambition. The father had the money. The father had also spent two decades sitting at the same conference tables as the sitting president of the United States.</P>
      </section>

      {/* ========== CH 01 ========== */}
      <section id="ch1" style={{ maxWidth: 920, margin: "0 auto", padding: "0 24px 64px" }}>
        <H2 num="01">The Son Rises</H2>
        <P>In January 2024, Skydance floated an all-cash bid of about $2.5B for National Amusements, the Redstone holding company. On April 2, Paramount's special committee gave Skydance an exclusive negotiating window. Four weeks later, Sony Pictures and Apollo Global Management walked in with a $26B non-binding proposal for the whole company.<Rf n={2}/></P>
        <P>On April 29, CEO Bob Bakish stepped down after souring on the Skydance talks. On May 3, the exclusive window lapsed. For the next six weeks three groups circled the wreckage: Skydance, Sony-Apollo, and a rolling cast of PE hopefuls.</P>
        <P>Skydance won by restructuring the offer. The final July 2, 2024 deal was a three-part contraption: $2.4B cash for National Amusements, $4.5B in cash and shares for public Class A/B stockholders, and $1.5B of primary capital pushed into the balance sheet. Enterprise value about $28B. Headline number, $8B.<Rf n={2}/></P>
        ...
        <P>The governance trade was the actual story. Ellison would be chairman and CEO. Jeff Shell, the NBCUniversal veteran Larry Ellison had quietly recruited, would be president. Shari Redstone would walk off the board with $1.75B in her pocket and, by most accounts, some lingering resentment about how thin that check had become by the end.<Rf n={2}/> A $400M breakup fee sat in the contract in case anyone tried to outbid them at the last minute. Nobody did.</P>
      </section>

      {/* ========== CH 02 ========== */}
      <section id="ch2" style={{ maxWidth: 920, margin: "0 auto", padding: "0 24px 64px" }}>
        <H2 num="02">The Long Closing</H2>
        <P>Signing the deal was the easy part. What came next was thirteen months of regulatory choreography. The SEC and the European Commission waved it through in February 2025.<Rf n={2}/> The FCC was the problem. Trump had returned to the White House with a suit already on file against CBS News, alleging a 60 Minutes edit of a Harris interview amounted to &ldquo;election interference.&rdquo; The suit was legally ridiculous. It was also a $16M checkpoint on the way to FCC approval.</P>
        <P>On July 2, 2025, Paramount settled with Trump for $16M.<Rf n={2}/> Twenty-two days later, the FCC approved the merger. Sixteen days after that, the company cancelled <em>The Late Show with Stephen Colbert</em>, whose host had called the settlement &ldquo;a big fat bribe&rdquo; on air. In October, Bari Weiss, founder of The Free Press, was installed as editor-in-chief of CBS News.<Rf n={19}/> The regulatory strategy and the editorial strategy turned out, in hindsight, to be the same strategy.</P>
        <Ed>This is the part of the story that unsettles even people who liked the deal. Getting Paramount Skydance across the finish line cost more than $8B. It also taught anyone considering the next big media merger that an administration could be paid in editorial concessions. The lesson was learned. It got applied, twice, to Warner Bros.</Ed>
        <P>On August 7, 2025, the deal finally closed.<Rf n={3}/> Ellison stood on a soundstage on the Paramount lot and declared it &ldquo;day one of a new Paramount.&rdquo;<Rf n={4}/> Market cap about $28B. Net debt about $15B. What nobody in the room mentioned was that Ellison already had another number in mind, one more than three times larger, for what he wanted to buy next.</P>
      </section>

      {/* ========== CH 03 ========== */}
      <section id="ch3" style={{ maxWidth: 920, margin: "0 auto", padding: "0 24px 64px" }}>
        <H2 num="03">First Hundred Days</H2>
        <P>Ellison ran Paramount for exactly thirty-four days before his first pass at WBD. The public story was a tech transformation. Paramount+, Pluto TV, and BET+ got migrated onto an Oracle-hosted backend. Generative AI got pushed into VFX, dubbing, and script work. And Tom Cruise re-upped for what Ellison called &ldquo;the next twenty years of blockbuster filmmaking.&rdquo;<Rf n={12}/></P>
        ...
        <P>The private story was an acquisition thesis. WBD was trading at $12.54 on September 10, 2025, a third of its post-merger price, and David Zaslav was burning credibility every quarter he failed to articulate a coherent streaming plan. Ellison had the cash backing, the tech vision, and a lot to prove. He moved.</P>
        <P>The opening shot, mid-September, was $19 a share, roughly 60% cash. Rejected. A week later Ellison came back at $22 with 67% cash and an unusual sweetener: Zaslav would stay on as co-CEO. Rejected. On October 13, $23.50 at 80% cash. Rejected again.<Rf n={1}/> By month-end WBD announced it was formally exploring strategic alternatives. The auction was now open.</P>
        <Ed>Three offers in thirty days is a siege. Ellison wasn't trying to find Zaslav's price; he was flushing other bidders into the open. It worked. Within a month Netflix and Comcast had both put non-binding proposals on the table, and Ellison had turned WBD from a sleepy quarterly loser into the most-watched M&amp;A target of the year.</Ed>
      </section>

      {/* ========== CH 04 ========== */}
      <section id="ch4" style={{ maxWidth: 920, margin: "0 auto", padding: "0 24px 64px" }}>
        <H2 num="04">Three Bidders, One Prize</H2>
        <P>The auction from November 2025 through February 2026 is, depending on how you count, the biggest M&amp;A process in American media history. Three buyers, three months, nine bids, a share price that nearly tripled from where it started. Here is the full ratchet, move by move.</P>
        <FadeIn>
        ...
        <P>On November 20, WBD took non-binding first-round bids. Paramount put $25.50 a share on the table for the whole company. Netflix bid only for studios, HBO, and HBO Max, and left linear cable behind. Comcast did the same. On December 1, binding bids were due. Paramount raised to $26.50 all-cash. Netflix and Comcast refined their carve-out proposals.<Rf n={1}/></P>
        <P>On December 4, the WBD board picked Netflix.<Rf n={5}/> $82.7B enterprise value at $27.75 a share for the streaming-and-studios company that would remain after a linear spin-off. Wells Fargo, HSBC, and BNP Paribas committed $59B in debt financing. Sarandos, who had spent a decade branding Netflix a &ldquo;builders, not buyers&rdquo; company, explained why this one was different. Under pressure from cinema operators, he also pledged a 45-day theatrical window for WBD's biggest releases through 2029.<Rf n={17}/></P>
        <Ed>Here's what most people missed on December 4: the Netflix deal was a carve-out. Crown jewels transferred to Netflix, cable business spun off into a separate public company. That made sense on a spreadsheet. It also gave Paramount an opening. Because the deal required shareholder approval of <em>both</em> halves, a hostile bidder for the whole company could offer WBD investors something Netflix couldn't, which is one clean exit price in cash.</Ed>
      </section>

      {/* ========== CH 05 ========== */}
      <section id="ch5" style={{ maxWidth: 920, margin: "0 auto", padding: "0 24px 64px" }}>
        <H2 num="05">The Hostile Turn</H2>
        <P>Four days later, on December 8, 2025, Paramount launched an all-cash tender offer for 100% of WBD at $30 a share. Implied enterprise value, about $108B.<Rf n={22}/> The WBD board rejected it inside a week. Ellison&rsquo;s financing partner, Jared Kushner&rsquo;s Affinity Partners, walked. Then, quietly, Larry Ellison stepped in personally to backstop the equity.</P>
        <P>From that point on the deal stopped looking like a normal M&amp;A auction and started looking more like a multi-front political campaign. Ancora Holdings (a $200M stake) threatened a proxy contest. Pentwater Capital published memos arguing Paramount was &ldquo;economically superior after regulatory risk.&rdquo; Mario Gabelli said GAMCO was &ldquo;highly likely to tender&rdquo; to Paramount. James Cameron warned that a Netflix win would gut theatrical. Harris Associates called both bids &ldquo;roughly comparable&rdquo; and sat on its hands.<Rf n={1}/></P>
        <P>On January 13, Netflix converted its offer to all-cash at the same $27.75 a share. Nine days later, the Department of Justice issued a Second Request, freezing the clock.<Rf n={1}/> That was the moment the Netflix deal died. The DOJ had not formally objected; every WBD shareholder watching the calendar simply understood Netflix was at least another year from closing. Cash now from Paramount, or paper-maybe later from Netflix.</P>
        ...
        <P>In early February, Paramount filed its 9th offer: still $30 cash, but now with a $0.25 quarterly &ldquo;ticking fee&rdquo; kicking in after Dec 31, 2026, plus full assumption of the $2.8B Netflix termination fee and help on WBD's financing costs. It was designed to make it more expensive for the WBD board to say no than yes.<Rf n={1}/></P>
      </section>

      {/* ========== CH 06 ========== */}
      <section id="ch6" style={{ maxWidth: 920, margin: "0 auto", padding: "0 24px 64px" }}>
        <H2 num="06">The Superior Proposal</H2>
        <P>On February 17, the WBD board granted Netflix a seven-day waiver from exclusivity, which reopened negotiations with Paramount. On February 19, Paramount's Hart-Scott-Rodino waiting period expired. That was the only regulatory clock running in parallel with Netflix's DOJ Second Request. Netflix pointed out, correctly, that HSR expiration is not antitrust clearance. Everyone understood what it actually meant. The optics were asymmetric.<Rf n={20}/></P>
        <P>On February 24, Paramount raised to $31 a share in cash, valuing WBD at about $110.9B. On February 26, WBD's board formally declared Paramount's bid a &ldquo;superior proposal&rdquo; under the terms of its Netflix merger agreement. Netflix had the contractual right to match. It had exactly twenty-four hours to decide.<Rf n={6}/><Rf n={9}/></P>
        ...
        <P>It was either the most disciplined capital allocation call Netflix has ever made, or it was the moment Netflix gave up its one chance to own the library of the last great legacy studio. Probably both, honestly. Netflix had the cash, the balance sheet, the operating momentum. What it didn't have was a backer willing to eat a five-to-seven-year integration penalty for a deal that wasn't obviously accretive at $31. The Ellisons had one.</P>
        <Timeline />
        <P>Paramount and WBD signed the final agreement on February 27, 2026.<Rf n={23}/> Over the next six weeks Paramount disclosed a financing structure unusual enough to deserve its own chart. About $47B of equity commitments, roughly half of it Gulf sovereign, sits next to $49B of bank debt syndicated across eighteen lenders led by BofA, Citi, and Apollo. The three Gulf investors took non-voting stakes to avoid triggering a CFIUS review. The Ellison family and RedBird kept 100% of the voting shares.<Rf n={10}/><Rf n={25}/></P>
        <FinancingChart />
      </section>
      ...
      <section id="ch7" style={{ maxWidth: 920, margin: "0 auto", padding: "0 24px 64px" }}>
        ...
        <P>Subject to regulatory approval, here is what Ellison will own once the dust settles. It is the biggest media asset in private hands since AOL Time Warner in 2000. Whether that comparison reads as flattering or as a warning depends on the next five years.<Rf n={13}/></P>
        <FadeIn>
        ...
        <P>The combined box office math is where the scale becomes clear. WB alone took roughly 21% of 2025 US domestic box office. Paramount added 6%. Together, if the combined studio holds that share, the new company sits shoulder-to-shoulder with Disney's 28%. That leaves Netflix's theatrical presence, which is essentially zero, as a structural weakness for the first time in a decade.<Rf n={13}/></P>
        <FadeIn>
        ...
        <P>On streaming, Ellison has said HBO Max and Paramount+ will collapse into a single service.<Rf n={16}/> The headline number is about 207M subs, though roughly a quarter of HBO Max subs in the US already pay for Paramount+, so the real post-integration number will be lower. Either way, the combined entity is the second-largest English-language subscription streamer by volume, behind Netflix's 325M and ahead of Amazon and Disney+.<Rf n={21}/></P>
        <P>Comcast spun its cable networks into Versant to shed the linear drag. Ellison has said flatly that Paramount is keeping the whole portfolio: HBO, CNN, TNT, TBS, Discovery, Food, HGTV, TLC, Cartoon Network, Adult Swim, Showtime, MTV, Nickelodeon, BET, Comedy Central, Paramount Network, and more.<Rf n={15}/> That is more than forty cable brands under one corporate roof, the biggest linear portfolio left in the private sector.</P>
        <Ed>The bet here is simple and contrarian. Linear TV is dying slower than anyone thinks, and the cash it throws off over the next five years is worth more than the optionality of selling it today. Every other major media company disagrees. If Ellison is right, Paramount becomes the last great cash-on-cash media compounder. If he&rsquo;s wrong, the debt eats him.</Ed>
      </section>

      {/* ========== CH 08 ========== */}
      <section id="ch8" style={{ maxWidth: 920, margin: "0 auto", padding: "0 24px 64px" }}>
        <H2 num="08">The Next Act</H2>
        <P>The auction is over. The regulatory fight is not. HSR lapsed on Feb 19 without DOJ action, but the DOJ antitrust chief went on record saying the review would &ldquo;absolutely not&rdquo; be fast-tracked for political reasons.<Rf n={20}/> California AG Rob Bonta opened a state review the same day. Eight Senate Democrats, led by Cory Booker, asked for documentation of every Paramount contact with the Trump administration. Senator Elizabeth Warren called the deal &ldquo;an antitrust disaster.&rdquo; The International Brotherhood of Teamsters asked the DOJ to block the merger unless Paramount agreed to &ldquo;substantial and enforceable&rdquo; safeguards covering its 15,000 Motion Picture Teamsters.<Rf n={18}/><Rf n={24}/></P>
        <P>Assume the deal closes by mid-2027. What kind of industry does that produce? Nobody, including the Ellisons, really knows yet. But the rough shape is legible. Four English-language media companies are big enough to matter at global scale: Netflix, Disney, Paramount-Warner, and Amazon. YouTube hovers above all of them as the uncategorizable fifth. Comcast/NBCUniversal has voluntarily shrunk into a studio-plus-theme-parks company. Everyone else (AMC Networks, Lionsgate, the mini-studios) is either an acquisition target or a specialist.<Rf n={13}/></P>
        ...
        <P>Inside Paramount-Warner, three bets get placed at once. First, AI. Oracle runs the streaming backend, and generative tools get pushed into VFX, dubbing, de-aging, and pre-viz. Ellison has talked about a future where you can &ldquo;have a conversation with your favorite character,&rdquo; a product no legacy studio has actually built yet.<Rf n={11}/> Second, theatrical, with 30 releases a year (15 per studio) and the 45-day window preserved. Third, bundling: HBO with Showtime, Discovery with Nickelodeon, CNN with CBS News, a full-stack distribution apparatus that negotiates with YouTube TV and Hulu Live from a position of rough parity.</P>
        <P>All three bets depend on the one thing Ellison can't buy, which is time. Linear TV keeps grinding down at about 6% a year. Streaming margins are compressing. Debt service on $79B starts day one. And Netflix, the company that walked at $31, is sitting on the biggest cash pile in media and hunting for content investments that don't require swallowing a cable portfolio or a 10,000-person newsroom.<Rf n={14}/> If Ellison can get through the next twenty-four months without a credit downgrade, a creative exodus, or a political realignment that turns the DOJ review hostile, he has a real shot. That's a lot of <em>ifs</em> stacked on top of each other.</P>
        <Ed>Scott Galloway&rsquo;s prediction, written the week the Netflix deal was signed, was that Bob Iger and David Zaslav will both be out inside twelve to twenty-four months. Traditional Hollywood leadership, he argued, is facing an opponent with capital, technology, and political access it cannot match. You don&rsquo;t have to agree with him to notice the second-order implication. If the Ellisons win, Hollywood basically becomes a two-family business: theirs, and whoever succeeds Iger at Disney. Everyone else is a vendor.</Ed>
      </section>

      {/* ========== CH 09 PLAYBOOK ========== */}
      <section id="ch9" style={{ maxWidth: 920, margin: "0 auto", padding: "0 24px 64px" }}>
        <H2 num="09">The Playbook</H2>
        <P>Whatever you think of the Ellisons, David&rsquo;s path from a Skydance producer credit to a $111B acquisition in twenty months is a master class in offensive M&amp;A. Here are the transferable lessons. You will probably never buy a studio, but the playbook generalizes to any contested auction.</P>
        ...
        <div style={{ marginTop: 56 }}>
          <P>The auction is done. The hard part starts now. Running a media company is a different sport from buying one, and David Ellison just inherited two of them on top of the one he was still learning. The next chapter is operational. Can a tech-forward, AI-native, politically-connected, Gulf-financed studio-and-cable-and-streaming conglomerate actually produce the hits, ratings, margins, and cash flow that $79B of debt demands?</P>
          <FadeIn>
      ...
      <section id="lh-sources" style={{ maxWidth: 920, margin: "0 auto", padding: "40px 24px 80px" }}>
        <FadeIn>
          ...
          <p style={{ fontFamily: "var(--lh-serif)", fontSize: 16, color: C.dim, lineHeight: 1.76, margin: "0 0 32px", maxWidth: 680 }}>Every figure and quote here was checked against at least one primary source. Where reporting differed, I deferred to the WBD press release or the Paramount 8-K.</p>
        </FadeIn>
        <FadeIn delay={0.08}>
