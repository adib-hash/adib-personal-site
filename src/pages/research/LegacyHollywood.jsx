...
const boxOffice2025 = [
  { name: "Disney", value: 28, color: "#60a5fa" },
  { name: "Warner Bros", value: 21, color: "#f59e0b" },
  { name: "Universal", value: 20, color: "#34d399" },
  { name: "Sony", value: 13, color: "#a78bfa" },
  { name: "Paramount", value: 6, color: "#fbbf24" },
  { name: "Other", value: 12, color: "#64748b" }
];
const financingData = [
  { source: "Bank debt (18-bank syndicate)", value: 49, color: "#dc2626", note: "BofA, Citi, Apollo + 15. Restructured from $54B bridge." },
  { source: "Ellison family + RedBird", value: 22, color: "#f59e0b", note: "100% of voting shares. The backstop that beat Netflix." },
  { source: "Assumed WBD net debt", value: 15, color: "#a78bfa", note: "Existing WBD leverage inherited at close." },
  { source: "Saudi Arabia — PIF", value: 10, color: "#60a5fa", note: "Largest Gulf stake. Non-voting." },
  { source: "Qatar — QIA TMT Holding", value: 7, color: "#3b82f6", note: "Non-voting co-investor." },
  { source: "Abu Dhabi — L'imad SPV", value: 7, color: "#2563eb", note: "Non-voting. Dodges CFIUS." },
  { source: "LionTree + others", value: 1, color: "#fbbf24", note: "Minority equity syndicate." }
];

const streamingLineup = [
  { name: "Netflix", subs: 325, rev: 45.2, color: "#ef4444" },
  { name: "Paramount+WBD", subs: 207, rev: 70.0, color: "#f59e0b" },
  { name: "Amazon", subs: 200, rev: 0, color: "#60a5fa" },
  { name: "Disney+", subs: 175, rev: 0, color: "#34d399" }
];

const empireSegments = [
  { name: "HBO Max + Paramount+", value: 24, color: "#f59e0b", detail: "~207M combined subscribers" },
  { name: "Warner Bros Studio", value: 16, color: "#fbbf24", detail: "21% of 2025 US box office" },
  { name: "Paramount Pictures", value: 8, color: "#fcd34d", detail: "6% box office, strong IP" },
  { name: "Cable Networks", value: 12, color: "#a78bfa", detail: "CNN, HBO, TNT, MTV, Nickelodeon, Discovery, Food, HGTV" },
  { name: "CBS", value: 7, color: "#60a5fa", detail: "News, sports, NFL rights" },
  { name: "Pluto TV + BET+", value: 3, color: "#34d399", detail: "FAST + niche streaming" }
];
...
function Ed({ children }) {
  return <FadeIn>
    <p style={{
      ...
      paddingLeft: 22,
      background: "linear-gradient(90deg, " + C.glow + " 0%, transparent 40%)",
      maxWidth: "100%"
    }}>{children}</p>
  </FadeIn>;
}
  ...
  return <FadeIn>
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ width: 20, height: 1, background: C.accent + "88" }} />
        <span style={{
          fontFamily: "var(--sans)",
          fontSize: 12,
          color: C.accent,
...
function StatCard({ value, label, sub, color }) {
  ...
  return <div style={{
    ...
    <div style={{
      ...
      right: 0,
      height: 2,
      background: "linear-gradient(90deg, " + col + ", " + col + "00)"
    }} />
    <div style={{
      fontFamily: "var(--mono)",
      fontSize: 9,
...
function NavBar({ active, show }) {
  ...
  return <nav style={{
    ...
    <div style={{
      ...
      }} onMouseEnter={function(e) { e.currentTarget.style.color = C.accent; }} onMouseLeave={function(e) { e.currentTarget.style.color = C.dim; }}>
  ...
  return <FadeIn>
    <div style={{
      ...
      {timelineEvents.map(function(ev, i) {
        ...
        return <div key={i} style={{
          position: "relative",
          marginBottom: i === timelineEvents.length - 1 ? 0 : 28
        }}>
          <div style={{
            position: "absolute",
            left: -28,
...
function FinancingChart() {
  ...
  for (var i = 0; i < financingData.length; i++) {
    ...
    var start = cum;
    cum += d.value;
    positions.push((start + d.value / 2) / total * 100);
  }
  ...
  return <FadeIn>
    <div style={{
      ...
      <div style={{
        ...
        marginBottom: 4,
        fontWeight: 600
      }}>How the $111B gets paid for</div>
      <div style={{
        fontFamily: "var(--sans)",
        fontSize: 15,
        color: C.muted,
        marginBottom: 28
      }}>USD billions. Hover a segment for detail.</div>
      ...
      <div style={{ position: "relative", marginBottom: 22 }}>
        <div style={{
          ...
          opacity: hd ? 1 : 0,
          transition: "opacity 0.18s, left 0.28s cubic-bezier(0.16,1,0.3,1)",
          pointerEvents: "none",
          background: C.bg,
          border: "1px solid " + (hd ? hd.color : C.border),
          borderRadius: 9,
          padding: "11px 14px",
          minWidth: 200,
          maxWidth: 280,
          ...
          <div style={{
            fontFamily: "var(--mono)",
            fontSize: 15,
            color: hd ? hd.color : C.muted,
            fontWeight: 800,
            marginBottom: 6
          }}>{hd ? "$" + hd.value + "B  ·  " + Math.round(hd.value / total * 100) + "% of deal" : ""}</div>
          <div style={{
            fontFamily: "var(--serif)",
            fontSize: 12,
            color: C.dim,
        ...
        {financingData.map(function(d, i) {
          ...
          return <div key={d.source}
            ...
            style={{
              ...
              alignItems: "center",
              padding: "10px 12px",
              background: isH ? d.color + "1a" : C.surface,
            ...
            <div>
              <div style={{ fontFamily: "var(--sans)", fontSize: 13.5, color: C.text, fontWeight: 600 }}>{d.source}</div>
              <div style={{ fontFamily: "var(--serif)", fontSize: 12, color: C.muted, marginTop: 2, lineHeight: 1.45 }}>{d.note}</div>
            </div>
            <div style={{ fontFamily: "var(--mono)", fontSize: 15, color: d.color, fontWeight: 800, textAlign: "right" }}>{"$" + d.value + "B"}</div>
          </div>;
        })}
      </div>
...
export default function LegacyHollywood() {
  ...
  return <div className="research-root-le" style={{
    background: C.bg,
    minHeight: "100vh",
    color: C.text,
    fontFamily: "var(--serif)"
    ...
    }} onMouseEnter={function(e) { e.currentTarget.style.color = C.accent; e.currentTarget.style.borderColor = C.accent + "80"; }} onMouseLeave={function(e) { e.currentTarget.style.color = C.dim; e.currentTarget.style.borderColor = C.faint; }}>
      <span style={{ fontSize: 14, lineHeight: 1 }}>&larr;</span>
      <span className="back-btn-label">Back</span>
    </Link>
    <style>{"@import url('https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;700;800;900&family=Source+Serif+4:ital,wght@0,400;0,600;1,400;1,600&family=IBM+Plex+Mono:wght@400;500;600&family=Outfit:wght@400;500;600;700;800&display=swap');"}</style>
    <style>{":root{--display:'Playfair Display',Georgia,serif;--serif:'Source Serif 4',Georgia,serif;--sans:'Outfit',system-ui,sans-serif;--mono:'IBM Plex Mono',Menlo,monospace}body{margin:0;background:#0a0604}*{box-sizing:border-box}::-webkit-scrollbar{width:0;background:transparent}"}</style>
    <style>{"@media (min-width:1024px){.research-root-le a[aria-label=\"Back to projects\"]{top:22px!important;left:22px!important;padding:10px 16px!important;font-size:12px!important;gap:8px!important}.research-root-le a[aria-label=\"Back to projects\"] span:first-child{font-size:15px!important}.research-root-le .back-btn-label::after{content:\" to projects\"}}"}</style>
    ...
    <section style={{
      ...
      <div style={{ position: "relative", zIndex: 2 }}>
        ...
        <h1 style={{
          ...
          Legacy Hollywood<span style={{ color: C.accent, fontWeight: 400 }}>:</span><br/>
          <span style={{
            ...
            padding: "0.14em 0.12em 0.22em 0",
            marginBottom: "-0.18em"
          }}>The Endgame</span>
        </h1>
        <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            right: 0,
            height: 3,
            background: "linear-gradient(90deg, " + C.accent + ", " + C.gold + ", " + C.accent + "00)"
          }} />
          <div style={{
            fontFamily: "var(--mono)",
            fontSize: 10,
          ...
          <p style={{
            ...
            margin: "0 0 26px",
            fontWeight: 400
          }}>On September 10, 2025, Warner Bros. Discovery traded at <strong style={{ color: C.red }}>$12.54</strong>. Twenty weeks later it sold for <strong style={{ color: C.accent }}>$31</strong> a share in cash. The loser walked away because the number got too high.<Rf n={1}/></p>
          ...
          <div style={{
            ...
            <div style={{ textAlign: "center", padding: "12px 4px" }}>
              <div style={{ fontFamily: "var(--display)", fontSize: 30, color: C.red, fontWeight: 800 }}>$12.54</div>
              <div style={{ fontFamily: "var(--mono)", fontSize: 9, color: C.muted, marginTop: 6, letterSpacing: "0.12em" }}>UNDISTURBED</div>
            </div>
            <div style={{ textAlign: "center", padding: "12px 4px", borderLeft: "1px solid " + C.border, borderRight: "1px solid " + C.border }}>
              <div style={{ fontFamily: "var(--display)", fontSize: 30, color: C.accent, fontWeight: 800 }}>$31.00</div>
              <div style={{ fontFamily: "var(--mono)", fontSize: 9, color: C.muted, marginTop: 6, letterSpacing: "0.12em" }}>FINAL OFFER</div>
            </div>
            <div style={{ textAlign: "center", padding: "12px 4px" }}>
              <div style={{ fontFamily: "var(--display)", fontSize: 30, color: C.gold, fontWeight: 800 }}>147%</div>
              <div style={{ fontFamily: "var(--mono)", fontSize: 9, color: C.muted, marginTop: 6, letterSpacing: "0.12em" }}>PREMIUM</div>
            </div>
          </div>
        </div>
    ...
    {/* ========== CH 00 ========== */}
    <section id="ch0" style={{ maxWidth: 820, margin: "0 auto", padding: "0 24px 60px" }}>
    ...
    {/* ========== CH 01 ========== */}
    <section id="ch1" style={{ maxWidth: 820, margin: "0 auto", padding: "0 24px 60px" }}>
    ...
    {/* ========== CH 02 ========== */}
    <section id="ch2" style={{ maxWidth: 820, margin: "0 auto", padding: "0 24px 60px" }}>
    ...
    {/* ========== CH 03 ========== */}
    <section id="ch3" style={{ maxWidth: 820, margin: "0 auto", padding: "0 24px 60px" }}>
    ...
    {/* ========== CH 04 ========== */}
    <section id="ch4" style={{ maxWidth: 820, margin: "0 auto", padding: "0 24px 60px" }}>
      ...
      <FadeIn>
        <div style={{
          ...
          <div style={{
            ...
            fontWeight: 700,
            marginBottom: 20
          }}>Per-share price, in USD, by bid round</div>
          <div style={{ height: 260, marginLeft: -20 }}>
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={bidData} margin={{ top: 16, right: 20, left: 10, bottom: 6 }}>
                ...
                <XAxis dataKey="stage" stroke={C.muted} tick={{ fontSize: 10, fontFamily: "var(--mono)" }} axisLine={false} tickLine={false} />
                <YAxis stroke={C.muted} tick={{ fontSize: 10, fontFamily: "var(--mono)" }} axisLine={false} tickLine={false} domain={[0, 34]} tickFormatter={function(v) { return "$" + v; }} />
                <Tooltip content={<Tip />} cursor={{ fill: C.accent + "10" }} />
                <ReferenceLine y={12.54} stroke={C.red} strokeDasharray="4 4" label={{ value: "Undisturbed $12.54", position: "insideTopLeft", fill: C.red, fontSize: 10, fontFamily: "var(--mono)" }} />
          ...
          <div style={{
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 7 }}><span style={{ width: 10, height: 10, background: C.accent, borderRadius: 2 }}/> Paramount</div>
            <div style={{ display: "flex", alignItems: "center", gap: 7 }}><span style={{ width: 10, height: 10, background: C.red, borderRadius: 2 }}/> Netflix</div>
    ...
    {/* ========== CH 05 ========== */}
    <section id="ch5" style={{ maxWidth: 820, margin: "0 auto", padding: "0 24px 60px" }}>
    ...
    {/* ========== CH 06 ========== */}
    <section id="ch6" style={{ maxWidth: 820, margin: "0 auto", padding: "0 24px 60px" }}>
    ...
    {/* ========== CH 07 ========== */}
    <section id="ch7" style={{ maxWidth: 820, margin: "0 auto", padding: "0 24px 60px" }}>
      ...
      <FadeIn>
        <div style={{
          ...
          <StatCard value="$70B" label="Combined Revenue" sub="Pro forma" color={C.gold} />
          <StatCard value="~207M" label="Streaming Subs" sub="HBO Max + Paramount+" color={C.accent2} />
          <StatCard value="$16B" label="Adj. EBITDA" sub="Pre-synergy" color={C.blue} />
          <StatCard value="$79B" label="Net Debt" sub="~5x leverage day one" color={C.red} />
      ...
      <FadeIn>
        <div style={{
          ...
          <div style={{
            ...
            marginBottom: 6,
            fontWeight: 600
          }}>2025 US domestic box office share</div>
          <div style={{
            fontFamily: "var(--sans)",
            fontSize: 14,
            color: C.muted,
            marginBottom: 18
          }}>Combined Paramount-Warner would overtake Disney.</div>
          <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
            {boxOffice2025.map(function(d) {
              return <div key={d.name} style={{
                flex: "1 1 " + (d.value * 3) + "%",
                minWidth: 100,
                ...
                <div style={{ color: C.text, fontSize: 13, fontWeight: 600, fontFamily: "var(--sans)" }}>{d.name}</div>
                <div style={{ color: d.color, fontSize: 24, fontWeight: 800, fontFamily: "var(--mono)", marginTop: 4 }}>{d.value + "%"}</div>
              </div>;
            })}
          </div>
          <div style={{
            ...
            <strong style={{ color: C.accent }}>Combined Paramount-Warner:</strong> 27% &mdash; a single market point below Disney.<Rf n={13}/>
          </div>
        </div>
      </FadeIn>
    ...
    {/* ========== CH 08 ========== */}
    <section id="ch8" style={{ maxWidth: 820, margin: "0 auto", padding: "0 24px 60px" }}>
    ...
    {/* ========== CH 09 PLAYBOOK ========== */}
    <section id="ch9" style={{ maxWidth: 820, margin: "0 auto", padding: "0 24px 60px" }}>
          ...
          return <FadeIn key={l.n}>
            <div style={{
              ...
              <div style={{
                ...
                width: 3,
                height: "100%",
                background: "linear-gradient(to bottom, " + C.accent + ", " + C.accent + "22)"
              }} />
      ...
      <div style={{ marginTop: 56 }}>
        ...
        <P style={{ color: C.text, fontSize: 20, fontFamily: "var(--display)", fontStyle: "italic" }}>That is the next chapter. And it has not been written yet.</P>
      </div>
    </section>

    {/* ========== SOURCES ========== */}
    <section id="sources" style={{ maxWidth: 820, margin: "0 auto", padding: "40px 24px 80px" }}>
      <FadeIn>
        <div style={{
          fontFamily: "var(--mono)",
          fontSize: 11,
        ...
        <p style={{
          ...
          lineHeight: 1.72,
          margin: "0 0 32px"
        }}>Every figure and quote was verified against at least one primary source. Where reporting differed, the WBD press release or Paramount 8-K was used.</p>
      </FadeIn>
      <div style={{
        background: C.card,
        border: "1px solid " + C.border,
        ...
        <div style={{ fontFamily: "var(--serif)", fontSize: 14.5, color: C.dim, lineHeight: 1.68 }}>
      ...
      <div style={{ display: "grid", gap: 8 }}>
        {sources.map(function(s) {
          return <a key={s.n} href={s.url} target="_blank" rel="noreferrer" style={{
            display: "grid",
            ...
            <div>
              <div style={{ fontSize: 13.5, color: C.text, fontWeight: 500, lineHeight: 1.4 }}>{s.title}</div>
    ...
    <footer style={{
      ...
      <div style={{
        ...
        fontStyle: "italic",
        marginBottom: 10
      }}>Legacy Hollywood: The Endgame</div>
      <div style={{
        fontFamily: "var(--mono)",
        fontSize: 10,
        color: C.muted,
        letterSpacing: "0.2em",
        textTransform: "uppercase"
      }}>A narrative by Claude &middot; April 2026</div>
    </footer>
  </div>;
}
