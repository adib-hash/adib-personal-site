  ...
  return (
    <section>
      ...
      <FadeIn>
        <p style={{
          fontFamily: "var(--nyt-serif)", fontSize: 15, color: C.muted,
          lineHeight: 1.65, textAlign: "center", maxWidth: 560,
          margin: "22px auto 40px"
        }}>
          Primary filings, financial press, and industry publications consulted in building
          this narrative, grouped by subject. Every link opens in a new tab.
        </p>
      </FadeIn>
                ...
                return (
                  <FadeIn key={g.group + "-" + i}>
                    <a href={s.url} target="_blank" rel="noopener noreferrer"
                      ...
                      <span style={{ fontFamily: "var(--nyt-sans)", fontSize: 10.5, color: C.red, minWidth: 22, flexShrink: 0, fontWeight: 700 }}>{(i + 1) < 10 ? "0" + (i + 1) : i + 1}</span>
      ...
      <main style={{ maxWidth: 760, margin: "0 auto", padding: "0 24px 100px" }}>
        ...
        <FadeIn delay={120}>
          <p style={{
            ...
            On May 7, 2026, NYT reported revenue up twelve percent year-over-year, digital
            advertising up thirty-one and a half percent, and net new digital subscribers of
            310,000 in three months. The stock jumped about eight and a half percent on the
            print. The company that almost defaulted in 2009 has become the only English-language
        ...
        <P first="B">y the autumn of 2008, The New York Times Company was running out of options. The print classified line — once roughly forty percent of newspaper ad revenue industrywide — had been gutted by Craigslist, which researchers Robert Seamans and Feng Zhu would later estimate had stripped about five billion dollars from U.S. newspapers between 2000 and 2007. The financial crisis had tanked the rest of the print display market. Brand advertising was migrating, structurally, to Google and Facebook. The Times had ridden three empire bets into the wrong end of the cycle: $1.1 billion paid in 1993 for The Boston Globe, $410 million in 2005 for About.com, and a Renzo Piano headquarters at 620 Eighth Avenue that had been completed in 2007 at a cost north of six hundred million. By early 2009, a four-hundred-million-dollar credit line was rolling toward expiration with no realistic refinancing path.</P>
        <P>The stock collapsed. Throughout the first half of 2009, NYT traded below five dollars. The dividend was suspended that year and would not be reinstated until 2013. Print advertising, which had still been over a billion dollars in 2008, was about to enter a multi-year free fall that would never reverse — by 2024, the entire ad line, print and digital combined, would total $506 million, less than half the 2008 print figure alone. The question inside the building was no longer how to grow. It was whether the company could remain solvent long enough to figure out what it was going to grow into.</P>
        ...
        <ChapterRule num="II" />
        <P first="O">n January 19, 2009, Carlos Slim Helú — at the time the wealthiest person in the world — extended the Times Company a $250 million senior unsecured loan. The coupon was fourteen percent. There was a twelve percent premium on redemption. And Slim received warrants to purchase 15.9 million shares of Class A stock at $6.36, exercisable until January 2015. The strike was struck almost exactly at the trough. The Times's treasurer, Tony Benten, would tell Poynter sixteen years later: "It was a very stressful time frame. We could have gotten a better rate, but the[ir] terms were much more restrictive."</P>
        ...
        <P>The asset disposals came quickly. In March 2009 the Times sold the leasehold to twenty-one floors of its Renzo Piano headquarters — about 750,000 square feet — to W. P. Carey for $225 million in a fifteen-year sale-leaseback at $24 million a year. (It would buy the leasehold back in 2019 for $245 million.) It sold its stake in the Boston Red Sox. It sold its New England regional papers. In August 2012 it sold About.com to IAC/Ask.com for $300 million — a roughly $110 million loss against the 2005 purchase price, with a $195 million impairment booked the same quarter. In October 2013, John Henry — the hedge-fund manager who had bought the Boston Red Sox — closed the purchase of The Boston Globe and The Worcester Telegram &amp; Gazette for $70 million, against the $1.1 billion the Times had paid in 1993. The Globe sold, as Ken Doctor put it at Nieman Lab, for less than four percent of what it had been worth in 1993 dollars.</P>

        <Acquisitions />

        <P>The Slim loan was redeemed in 2011. The warrants were exercised in January 2015, with the stock then at $12.60 — a paper profit Bloomberg estimated at over $263 million on the warrants alone, on top of roughly $122 million of interest and the redemption premium. Slim held the position another five years, selling down through early 2020. He never sought board representation. He had simply written the check that no one else would, taken the equity kicker the hour demanded, and held it as the stock did its work.</P>
        ...
        <ChapterRule num="III" />
        <P first="T">hree executives carried the transformation. <strong>Mark Thompson</strong> — the outgoing Director-General of the BBC, where he had run a £4 billion organization since 2004 — was hired as CEO in August 2012 and took the corner office in November. He was a broadcaster, not a newspaperman, which the board had decided was a feature. Thompson brought broadcast-style audience thinking into a print-centric newsroom, launched Cooking and the NYT Now app, hired Meredith Kopit Levien from Forbes in 2013, and pushed digital subscriptions from somewhere around five hundred thousand to roughly six and a half million during his eight-year tenure. The stock rose from about nine dollars to over forty-six. CNBC, at his exit, called it a roughly four-hundred-percent gain.</P>
        <P><strong>Meredith Kopit Levien</strong> became CEO on September 8, 2020. She was forty-nine. She had come up through advertising sales — first at Forbes Media, then at the Times since 2013, where she had remade the entire ad organization (turning over seventy-five to eighty percent of the sales staff in her first fifteen to eighteen months, by her own account to Nieman Lab). She had been Thompson's chief operating officer since 2017. The strategic plan she released in her first year, "Times2020," identified NYT explicitly as "a subscription-first business." She would, more than anyone else, industrialize the bundle.</P>
        <P><strong>A.G. Sulzberger</strong>, the sixth-generation Ochs-Sulzberger to take the publisher's chair, became publisher on January 1, 2018, at the age of thirty-seven. Before that — and the timing matters — he had been the lead author of the 96-page internal memo, the Innovation Report, that diagnosed the cultural failure to be digital-first in May 2014. He took the combined chairman-and-publisher title on January 1, 2021. He was the inheritor of the family's structural patience and, simultaneously, the document that converted the patience into a plan.</P>
        <P>Editorial credibility came from two executive editors. <strong>Dean Baquet</strong>, the first Black executive editor of the Times, ran the newsroom from May 2014 to June 2022 and oversaw eighteen Pulitzer Prizes — Weinstein and #MeToo, the 1619 Project, the Trump tax returns. <strong>Joe Kahn</strong>, a 24-year veteran of the paper and two-time Pulitzer winner, took over in June 2022. Their work was not a charity; it was the business. The entire bundle proposition rests on NYT being the must-have English-language news subscription. Without the journalism, there is no bundle.</P>
        ...
        <P first="O">n March 28, 2011, The New York Times turned on its metered paywall. Non-subscribers got twenty free articles per month. After that, a soft wall asked them to pay — initially $8.75 a week for the digital basic plan. The consensus view among media commentators, captured in Jay Rosen's retrospective at PressThink, was that it would fail. The free-online ad model was the model; everyone was sure of it. There were paywall failures already documented across the industry. The cynicism was nearly total.</P>
        <P>Within three months, 224,000 people were paying. By the end of 2013, the Times had 727,000 digital-only subscribers, generating about $150 million of annualized "new" digital reader revenue — the number Ken Doctor calculated in November 2013, in the Nieman Lab piece that, more than any other contemporaneous analysis, captured how big a deal the paywall already was. The number doubled, then doubled again. By the end of 2020, the company had more than five million digital-only news subscribers and a stock price north of forty-six dollars. By February 2022, after the close of The Athletic acquisition, the Times hit ten million subscribers — about three years ahead of the 2025 target it had set in 2019. By Q1 2026 the number was 12.52 million digital-only, 13.08 million in total.</P>
        ...
        <ChapterRule num="IX" />
        <P first="O">n December 27, 2023, The New York Times Company filed suit against Microsoft and OpenAI in the Southern District of New York, alleging unlawful copying of millions of Times articles to train GPT models. The complaint included specific allegations of verbatim regurgitation by ChatGPT of paywalled articles and Wirecutter recommendations. OpenAI's response, still on its website, called the suit "a surprise and disappointment" and argued the use was fair. In January 2025, three publisher cases — the Times's, the New York Daily News's, and the Center for Investigative Reporting's — were consolidated before Judge Sidney Stein.</P>
        <P>The lawsuit is, financially, a long-tail option. The Times's damages theory rests on statutory damages of up to $150,000 per willful infringement, applied to millions of articles. The math is enormous and largely speculative. But the strategic logic was clear: the Times had been the only major American news organization willing to be the named plaintiff against the largest generative-AI company in the world, and the longer the case proceeded without settlement, the more leverage the Times accumulated in licensing negotiations with every other AI lab.</P>
        <P>On May 29, 2025, that leverage produced its first deal. The Times announced its first generative-AI licensing agreement: a multi-year contract with Amazon, covering NYT, NYT Cooking, and The Athletic content. (Wirecutter was carved out, per the Axios source.) The terms were initially undisclosed. On July 30, 2025, the Wall Street Journal reported, citing people familiar, that the deal was worth twenty to twenty-five million dollars a year — "nearly one percent of the Times's total 2024 revenue" — confirmed the same day by GeekWire and PYMNTS. Levien's internal memo characterized it as "consistent with our long-held principle that high-quality journalism is worth paying for." Aaron Rubin of Gunderson Dettmer told Digiday the deal implied that using NYT content without a license "may not be a fair use" — strengthening the damages case in the same motion.</P>
        ...
        <P>The structural risk is real and unresolved. Generative AI in search — Google's AI Overviews, ChatGPT-as-default research interface — is compressing the top of the funnel for every English-language publisher. The mitigation is precisely the bundle. Bundled subscribers come direct, not through search. They engage with Games, Cooking, The Athletic and audio in addition to news. They are habit-driven. They are insulated. Only about one-eighth of NYT's subscribers are news-only; the other seven-eighths are bundle or other-product subscribers whose relationship with the company does not depend on a Google referral. This is the moat. Whether it is wide enough to outlast the deflation in search traffic is the open question.</P>

        <P>The easiest way to see what the Times did is to look at what its closest peers did not. The Washington Post is the cleanest counterfactual: a national newsroom, comparable brand equity, a billionaire owner (Jeff Bezos, who paid $250 million in 2013) with the resources to make any structural bet. In January 2021 the Post had roughly three million digital subscribers and its traffic peaked that month. Five years later, WSJ reporting (citing people familiar, never officially confirmed) puts losses at $77 million in 2023, $100 million in 2024, and $100 million in 2025. Executive editor Sally Buzbee resigned suddenly on June 2, 2024. In October 2024, publisher Will Lewis spiked the Post's Kamala Harris endorsement on Bezos's instructions; more than 250,000 subscribers reportedly cancelled. In February 2026 the Post laid off roughly one-third of its newsroom and Lewis stepped down. The Post never built a bundle. It never built the lifestyle stack. It maintained a single-product subscription on a brand that, while strong, was not strong enough to support the same pricing power. Gannett, the largest U.S. local-newspaper chain, is similar: revenue down from $3.21 billion (2021) to $2.51 billion (2024), a $100 million cost reduction announced in 2025, a forecast net loss. NYT is the exception.</P>

        <Peers />

        <P>What current management is trying to do, in plain language, is hit fifteen million subscribers by the end of 2027, convert the bundle into the dominant English-language consumer-news product on Earth, and price AI licensing into a meaningful revenue line. The benchmarks the company watches — 310,000 net digital adds against a consensus of about 270,000 in Q1 2026, ARPU growth of 2.4 percent year-over-year, bundle penetration trending past fifty percent, digital ad growth in double digits — are the numbers that confirm or refute the thesis. The structural compounders are in place. The print line is residual. The dividend is rising. The buyback is active. The newsroom is the largest in the company's history. The bundle is the moat. The AI licensing line has begun to scale. The lawsuit is unresolved but, in either direction, accretive to leverage.</P>
