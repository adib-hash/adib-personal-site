...
export default function BondBroccoli() {
  ...
  return (
    <div className="jb-root" style={{ background: C.bg, minHeight: "100vh", color: C.text, fontFamily: "var(--jb-serif)" }}>
      <Seo title="The Family Behind the Gun Barrel — Adib Choudhury" description="For 64 years, one family held sole creative control over James Bond. Thirteen chapters on the 1961 handshake deal with United Artists, the Daniel Craig casting revolt, the Sony hack, Amazon's $8.45B MGM buyout, and the ~$1B deal that ended family control in 2025." />
      ...
      <ResearchFooter currentSlug="bond-broccoli" />
