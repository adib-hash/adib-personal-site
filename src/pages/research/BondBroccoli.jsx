...
const chapters = [
  ...
  { id: "ch10", num: "10", short: "Faceoff", title: "Bond vs. the Multiverse" },
  { id: "ch11", num: "11", short: "Villeneuve", title: "The Villeneuve Mission" },
];
...
const controlEvents = [
  ...
  { year: "1962", phase: "founding", title: "Danjaq is born", body: "Broccoli and Saltzman set up Danjaq S.A. as the holding company that owns the Bond film copyrights and licenses them to Eon for production — the legal wrapper that keeps ownership in family hands." },
  ...
  return (
    <div className="jb-root" style={{ background: C.bg, minHeight: "100vh", color: C.text, fontFamily: "var(--jb-serif)" }}>
      ...
      <section id="ch0" style={{ maxWidth: 920, margin: "0 auto", padding: "0 24px 64px" }}>
        ...
        <P>Every big franchise character in film has an owner, and almost every one of those owners is a corporation — Disney owns Marvel, Sony owns Spider-Man's film rights, Universal owns the Dark Universe it keeps trying to relaunch. James Bond is the strange exception. From 1961 until February 2025, the person who decided who played 007, what the story was, and how much the studio was allowed to spend was, functionally, a single family: first Albert &ldquo;Cubby&rdquo; Broccoli, then his daughter Barbara Broccoli and stepson Michael G. Wilson.</P>
        <P>That is not a metaphor about creative influence. It is a literal, contractual fact, baked into the financing agreement that got the first film made in 1962 and never renegotiated away for 64 years — through six changes of leading man, three changes of American distributor, one bankruptcy, one hostile rights dispute, and one leaked cache of studio emails that showed a Hollywood executive trying, and mostly failing, to tell the Broccolis what to do.</P>
        <Ed>This is the story of how that arrangement got built, how it survived everything Hollywood could throw at it, and why Amazon ultimately had to write a check reported at roughly a billion dollars just to get the same creative authority most studios simply assume they already have.</Ed>
        <StatRow />
      </section>
      ...
      <section id="ch1" style={{ maxWidth: 920, margin: "0 auto", padding: "0 24px 64px" }}>
        ...
        <P>What happened next is the hinge the entire franchise swings on. United Artists' Arthur Krim agreed to finance and distribute the first film — and let Broccoli and Saltzman run the productions themselves, with UA financing the budget and taking distribution economics but not a creative vote. For an unproven spy picture with no stars attached, that was an unusual concession from a studio.<Rf n={1}/></P>
        <P>The following year, Broccoli and Saltzman formalized the arrangement by setting up Danjaq S.A. — the name a portmanteau of their wives Dana Broccoli and Jacqueline Saltzman — as the holding company that would own the Bond film copyrights outright and license them to Eon for production.<Rf n={4}/> Dr. No released in 1962 with Sean Connery in the lead, reportedly cast in part because Dana Broccoli pushed for him over the studio's preferred, more conventionally polished leading men.<Rf n={2}/></P>
        <Ed>Two decisions made in the span of about eighteen months — UA's decision to fund without controlling, and Broccoli/Saltzman's decision to wrap ownership in a private holding company rather than sell the rights outright — are the entire reason this story is different from every other franchise's. Everything that follows for the next six decades is a variation on that same structure.</Ed>
      </section>

      {/* ========== CH 02 ========== */}
      <section id="ch2" style={{ maxWidth: 920, margin: "0 auto", padding: "0 24px 64px" }}>
        <H2 num="02">The Machine Behind the Gun Barrel</H2>
        <P>Danjaq is easy to misunderstand as a formality. It isn't. It is the mechanism. Danjaq LLC owns the trademarks tied to Bond outright, and co-owns the copyrights to the individual films alongside the studio partner (United Artists, and later its corporate successor MGM).<Rf n={4}/> Whoever controls Danjaq controls whether a Bond film gets made at all, who directs it, who stars in it, and what the story is — the studio's role, historically, has been to write checks and distribute.</P>
        ...
        <SkyfallSplit />
        <P>The economics reinforce the authority. Danjaq's standard arrangement with its studio partners has reportedly included a share of profits in the 20&ndash;35% range plus, crucially, &ldquo;first-dollar gross&rdquo; participation — meaning the family's production company starts collecting before the studio has even recouped its costs.<Rf n={5}/> A studio that has to negotiate around that kind of position every single time is not in a strong spot to also dictate who wears the tuxedo.</P>
      </section>

      {/* ========== CH 03 ========== */}
      <section id="ch3" style={{ maxWidth: 920, margin: "0 auto", padding: "0 24px 64px" }}>
        <H2 num="03">The Battle of the Bonds</H2>
        <P>There is exactly one hole in this chain of custody, and it is instructive precisely because of how it happened. In 1961, producer Kevin McClory sold Eon the screen rights to Thunderball, which was based on an original story he had developed with Fleming and writer Jack Whittingham. McClory's deal gave him a producer credit and a share of profits — and a clause preventing him from making a rival Thunderball film for only ten years.<Rf n={6}/></P>
        <P>A decade later, that clock ran out. In the mid-1970s McClory began developing his own version, working with writer Len Deighton and, eventually, Sean Connery himself. The result, Never Say Never Again, released in 1983 through Jack Schwartzman's independent Taliafilm — not Eon, not Danjaq, not the Broccolis in any capacity — opposite Eon's own Octopussy, starring Roger Moore, that same year. The press immediately dubbed it the &ldquo;Battle of the Bonds.&rdquo;<Rf n={6}/></P>
        <Quote author="Coverage of the 1983 release" role="widely reported at the time">Two James Bonds, two studios, one summer. It took twenty years for a decade-old contract loophole to produce the only Bond film Cubby Broccoli couldn't stop.</Quote>
        <P>McClory spent the following decades attempting further Bond projects, and the legal fog around his rights wasn't fully resolved until 2013, when MGM and Danjaq settled with the McClory estate and folded the remaining disputed material back under Eon's umbrella for good.<Rf n={7}/> The lesson embedded in the episode is simple: the one time in 64 years that the Broccolis lost creative control of Bond, it happened through a contract clause nobody had bothered to close, not through a studio outbidding them or a corporate parent overruling them.</P>
      </section>
      ...
      <section id="ch4" style={{ maxWidth: 920, margin: "0 auto", padding: "0 24px 64px" }}>
        ...
        <ControlTimeline />
        <Ed>Compare this to almost any studio-owned franchise, where creative leadership turns over with the executive suite — a new studio chief, a new president of production, a new mandate. Bond changed producers exactly once between 1962 and 2025, and it happened via inheritance, not acquisition.</Ed>
      </section>
      ...
      <section id="ch5" style={{ maxWidth: 920, margin: "0 auto", padding: "0 24px 64px" }}>
        ...
        <P>None of it moved Broccoli and Wilson. There was no studio committee to overrule them, no test-screening data to appeal to, no marketing department with veto power — the decision belonged to the family, and the family had already made it. Casino Royale released in 2006 to some of the best reviews in the franchise's history, and within a few years Craig's take on the character was widely regarded as the definitive one.<Rf n={9}/><Rf n={10}/></P>
        <Ed>It is worth sitting with what this episode actually demonstrates. A public relations disaster large enough to spawn multiple protest websites and a national tabloid pile-on did not produce a single public wobble from the people who controlled the decision. That is what unilateral creative authority looks like in practice — not the absence of controversy, but complete immunity to it.</Ed>
      </section>

      {/* ========== CH 06 ========== */}
      <section id="ch6" style={{ maxWidth: 920, margin: "0 auto", padding: "0 24px 64px" }}>
        <H2 num="06">Reinventing 007 By Force of Will</H2>
        <P>Casting Craig was only the visible part of a much larger bet. Casino Royale didn't just recast the lead; it discarded two decades of gadget-driven, quip-heavy Bond formula for something closer to grounded thriller — a reinvention of tone, structure, and the character's emotional register that a studio-run franchise would typically require years of committee process and multiple test screenings to greenlight.</P>
        ...
        <P>The through-line from Chapter 05 to here is the actual thesis of this piece: the Broccoli family's power was never really about picking actors. It was the standing authority to bet the entire direction of a $7.8 billion franchise on instinct, publicly, against pushback, and to be answerable to no one for the outcome.<Rf n={33}/></P>
      </section>
      ...
      <section id="ch7" style={{ maxWidth: 920, margin: "0 auto", padding: "0 24px 64px" }}>
        ...
        <P>Spectre still released with its budget largely intact and its third act rewritten to the producers' satisfaction, not the studio's original preference.<Rf n={12}/><Rf n={13}/> Both episodes are useful precisely because they show the limits of what a financing partner could actually do: apply pressure, negotiate, complain in emails that later leaked to the world &mdash; but not overrule.</P>
      </section>
      ...
      <section id="ch9" style={{ maxWidth: 920, margin: "0 auto", padding: "0 24px 64px" }}>
        ...
        <Ed>Whatever the precise number, the shape of the transaction is the real story: for the first time since Arthur Krim shook hands with Broccoli and Saltzman in 1961, the studio holding the checkbook is also holding the pen.</Ed>
      </section>

      {/* ========== CH 10 ========== */}
      <section id="ch10" style={{ maxWidth: 920, margin: "0 auto", padding: "0 24px 64px" }}>
        <H2 num="10">Bond vs. the Multiverse</H2>
        <P>It's worth pausing to notice how unusual all of this actually is, because the default arrangement for beloved film characters looks nothing like it. Take Spider-Man. In 1996, a nearly bankrupt Marvel proposed selling film rights to almost its entire character roster — Iron Man, Thor, Black Panther, dozens more — for a combined $25 million. Sony wasn't interested in the bundle. It wanted only Spider-Man, and got the film and TV rights in 1998 for roughly $7 million.<Rf n={25}/></P>
        <P>That deal effectively split the character in two, permanently. Sony owns the film rights outright, in perpetuity, so long as it keeps releasing a movie every five years and nine months or so — a clause literally built to force output regardless of creative readiness.<Rf n={26}/> Marvel Studios, meanwhile, only gets to use the character in the MCU through a separate, renegotiated, revenue-sharing arrangement that Sony could in principle end. The character has been rebooted twice on screen since 2002 — the Raimi trilogy, then the Amazing Spider-Man relaunch, then folded into the MCU — each time as two studios renegotiated who got what.<Rf n={25}/></P>
        <Faceoff />
        <P>The contrast is the whole point. Spider-Man's ownership was split at the moment of sale and has stayed split for almost thirty years, which is precisely why the character keeps rebooting: every few years, the incentives of two separate corporate owners have to be re-aligned. Bond's ownership was never split at all until 2025. One party held every lever — casting, script, budget, release cadence — for 64 uninterrupted years, which is exactly why the franchise has recast its lead seven times without ever needing to &ldquo;reboot&rdquo; anything.</P>
      </section>

      {/* ========== CH 11 ========== */}
      <section id="ch11" style={{ maxWidth: 920, margin: "0 auto", padding: "0 24px 64px" }}>
        <H2 num="11">The Villeneuve Mission</H2>
        <P>The new arrangement's first major decision came fast. In June 2025, Amazon MGM Studios announced Denis Villeneuve — the director of Dune, Dune: Part Two, Arrival, and Blade Runner 2049 — would direct the next Bond film. Notably, even Villeneuve signed on a single-picture deal without final cut, the same limit Eon directors have traditionally worked under — except this time the studio, not the Broccolis, holds that final say.<Rf n={27}/><Rf n={28}/></P>
        ...
        <P>Whoever is cast will be the first Bond chosen without a single Broccoli in the room — the first casting decision in the character's history made entirely inside a corporate studio's process rather than a family's private judgment. It is, in a narrow sense, exactly the kind of decision Amazon paid roughly a billion dollars to be allowed to make.<Rf n={32}/></P>
        <div style={{ marginTop: 56 }}>
          <P>Sixty-four years is a long time for any two people to hold a veto over a global franchise, and there's a reasonable argument that Amazon MGM's operational scale, technology, and global reach will do things for Bond that a small family production company never could. There's an equally reasonable argument that the entire appeal of Bond as a character — stubbornly consistent, defiantly resistant to reboot, unbothered by fashion — was a direct product of exactly the kind of insulated, unaccountable authority that no longer exists.</P>
          <FadeIn>
