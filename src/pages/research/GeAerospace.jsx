  ...
  return (
    <div className="ge-root" style={{ background: C.bg, minHeight: "100vh", color: C.text, fontFamily: "var(--ge-serif)" }}>
      ...
      <section id="ch4" style={{ maxWidth: 960, margin: "0 auto", padding: "0 24px 64px" }}>
        ...
        <Ed>The difference between FLIGHT DECK and the Six Sigma culture it replaced is the part I keep coming back to. Six Sigma was expert-driven: Black Belts parachuted into factories with statistical models. It produced what Culp called &ldquo;quarter-end heroics&rdquo;, the scramble to hit a number, which he found genuinely dysfunctional. FLIGHT DECK runs the other way. It's bottom-up. Every employee does kaizen. The old philosophy was &ldquo;hire smart people to fix things.&rdquo; FLIGHT DECK&rsquo;s is &ldquo;teach everyone to improve their corner of the shop, every day.&rdquo;</Ed>
